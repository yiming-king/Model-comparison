...
path <- "/Users/mandyking/benchmark/benchmark/examples/gaussian/stan"
data_path <-"/Users/mandyking/benchmark/benchmark/examples/gaussian/stan/json_n10"
output_path <- "/Users/mandyking/benchmark/benchmark/examples/gaussian/stan/stan_output_df3_n10"

dir.create(output_path, recursive = TRUE, showWarnings = FALSE)
stan_model <- rstan:: stan_model("/Users/mandyking/benchmark/benchmark/examples/gaussian/stan/student_t.stan")
...
for (data_file in data_files) {
  ...
  stan_data<-list(
    ...
    obj$gold_post_samples<-unname(split(mu_1000, row(mu_1000)))
    ...
    obj$gold_log_marginal <- as.numeric(log_ml)
